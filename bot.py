...
NOT_EVENT_WORDS = [
    ...
    # 🔥 НОВОЕ: Корпоративная душнота, compliance и регламенты
    ...
    # ❌ Языки программирования и курсы для новичков
...
KZ_CITIES = {
    ...
    "астана": "Астана", "astana": "Астана", "nur-sultan": "Астана", "nursultan": "Астана", "нур-султан": "Астана",
    "шымкент": "Шымкент", "shymkent": "Шымкент",
    
    # Областные центры и крупные города
    "усть-каменогорск": "Усть-Каменогорск", "ust-kamenogorsk": "Усть-Каменогорск", "oskemen": "Усть-Каменогорск", "өскемен": "Усть-Каменогорск",
    "кызылорда": "Кызылорда", "kyzylorda": "Кызылорда", "qyzylorda": "Кызылорда",
    "актобе": "Актобе", "aktobe": "Актобе", "aqtobe": "Актобе",
    "тараз": "Тараз", "taraz": "Тараз",
    "павлодар": "Павлодар", "pavlodar": "Павлодар",
    "петропавловск": "Петропавловск", "petropavlovsk": "Петропавловск",
    "семей": "Семей", "semey": "Семей",
    "атырау": "Атырау", "atyrau": "Атырау",
    "жезказган": "Жезказган", "жезқазған": "Жезказган", "zhezkazgan": "Жезказган", "jezqazgan": "Жезказган",
    "актау": "Актау", "aktau": "Актау", "aqtau": "Актау",
    "конаев": "Конаев", "qonaev": "Конаев", "konaev": "Конаев", "qonayev": "Конаев", "қапшағай": "Конаев", "капчагай": "Конаев",
    "талдыкорган": "Талдыкорган", "taldykorgan": "Талдыкорган", "taldyqorgan": "Талдыкорган", "талдықорған": "Талдыкорган",
    "кокшетау": "Кокшетау", "kokshetau": "Кокшетау", "көкшетау": "Кокшетау",
    "костанай": "Костанай", "kostanay": "Костанай", "қостанай": "Костанай",
    "караганда": "Караганда", "karaganda": "Караганда", "qaraghandy": "Караганда", "қарағанды": "Караганда",
    ...
    "экибастуз": "Экибастуз", "ekibastuz": "Экибастуз",
    "рудный": "Рудный", "rudny": "Рудный",
    "жанаозен": "Жанаозен", "zhanaozen": "Жанаозен", "жаңаөзен": "Жанаозен",
    "балхаш": "Балхаш", "balkhash": "Балхаш",
    "сатпаев": "Сатпаев", "satpayev": "Сатпаев",
    "каскелен": "Каскелен", "kaskelen": "Каскелен",
