...
NOT_EVENT_WORDS = [
    # Новости, которые не являются ивентами
    ...
    # ❌ Исключаем Machine Learning (полными фразами, чтобы не задеть HTML)
    "machine learning", "машинное обучение", "машинному обучению", "машинного обучения",
    
    # ❌ Госорганы, налоги, бюрократия
    ...
    "проверк", "инспекци", "сдача отчет",
    
    # ❌ Традиционный бизнес (не стартапы)
    "салон красоты", "маникюр", "повар", "кулинар", "швея", "шитье", "кройк",
    "строительств", "ремонт", "сантехник", "электрик", "сварщик",
    
    # ❌ Детские мероприятия
    "детский сад", "утренник", "школьная ярмарка", "для детей от", "детский лагерь"
]
SITE_STOP_WORDS = [
